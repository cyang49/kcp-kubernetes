...
func newKcpListWorkEstimator(countFn KcpObjectCountGetterFunc) WorkEstimatorFunc {
	estimator := &kcpListWorkEstimator{
		countGetterFn: countFn,
	}
	return estimator.estimate
}

type kcpListWorkEstimator struct {
	countGetterFn KcpObjectCountGetterFunc
}

func (e *kcpListWorkEstimator) estimate(r *http.Request, flowSchemaName, priorityLevelName string) WorkEstimate {
	...
	numStored, err := e.countGetterFn(cluster.Name.String(), key(requestInfo))
